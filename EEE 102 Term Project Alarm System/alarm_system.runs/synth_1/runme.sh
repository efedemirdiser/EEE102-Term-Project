...
HD_PWD='C:/VivadoProjects/EEE_102_Project_Final_Demo/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alarm_main.tcl
