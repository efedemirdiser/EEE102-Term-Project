...
HD_PWD='C:/VivadoProjects/EEE_102_Project_Final_Demo/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alarm_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alarm_main.tcl -notrace
